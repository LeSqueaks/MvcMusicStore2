...
namespace System.Web.Administration {
    ...
    public class WebAdminPage : Page {
        ...
        private Configuration OpenWebConfiguration(string path, string appPhysPath, bool getWebConfigForSubDir) {
            ...
            //Changed based on https://stackoverflow.com/questions/19798880/asp-net-website-administrator-tool-in-vs-2013#24964121 instructions  can also use domain name or IP Address instead of localhost
    ...
    public sealed class WebAdminModule : IHttpModule {
        ...
        private void OnEnter(Object sender, EventArgs eventArgs) {
            ...
            //Changed
            // Commented out (because using localhost).  Uncomment if using other parameters
            //4.4 https://stackoverflow.com/questions/19798880/asp-net-website-administrator-tool-in-vs-2013#24964121
        ...
        private void SetSessionVariables(HttpApplication application) {
            ...
            // 4.2&4.3 https://stackoverflow.com/questions/19798880/asp-net-website-administrator-tool-in-vs-2013#24964121
            //May need to alter path name!  End with a Backslash

            if (application.Context.Request != null) {
                queryStringAppPath = "/";
                queryStringApplicationPhysicalPath = @"C:\Users\Squeaks\Documents\Visual Studio 2015\Projects\MvcMusicStore2\MvcMusicStore2\";
            }
